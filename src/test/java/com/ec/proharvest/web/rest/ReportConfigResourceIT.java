...
//             .content(TestUtil.convertObjectToJsonBytes(reportConfig)))
...
//         assertThat(testReportConfig.getTitle()).isEqualTo(DEFAULT_TITLE);
...
//             .contentType(MediaType.APPLICATION_JSON)
//             .content(TestUtil.convertObjectToJsonBytes(updatedReportConfig)))
//             .andExpect(status().isOk());
...
//         assertThat(testReportConfig.getTitle()).isEqualTo(UPDATED_TITLE);
