...
//             .content(TestUtil.convertObjectToJsonBytes(reportingDataSet)))
...
//     @Test
//     @Transactional
//     public void getAllReportingDataSet() throws Exception {
...
//             .contentType(MediaType.APPLICATION_JSON)
//             .content(TestUtil.convertObjectToJsonBytes(updatedReportingDataSet)))
//             .andExpect(status().isOk());
...
//         // Initialize the database
//         reportingDataSetRepository.saveAndFlush(reportingDataSet);
//         when(mockReportingDataSetSearchRepository.search(queryStringQuery("id:" + reportingDataSet.getId())))
//             .thenReturn(Collections.singletonList(reportingDataSet));
