...
public class ReportFileResourceIT {
    ...
    public void createReportFile() throws Exception {
        ...
        ReportFileDTO reportFileDTO = reportFileMapper.toDto(reportFile);
        restReportFileMockMvc.perform(post("/api/report-files").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(reportFileDTO)))
    ...
    public void updateReportFile() throws Exception {
        ...
        updatedReportFile
            ...
            .modified(UPDATED_MODIFIED)
            .path(UPDATED_PATH);
        ReportFileDTO reportFileDTO = reportFileMapper.toDto(updatedReportFile);
