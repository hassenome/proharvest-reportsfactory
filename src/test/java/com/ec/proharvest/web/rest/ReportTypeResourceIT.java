...
//         assertThat(testReportType.getReference()).isEqualTo(DEFAULT_REFERENCE);
//         assertThat(testReportType.getCategory()).isEqualTo(DEFAULT_CATEGORY);
...
//         assertThat(testReportType.getReference()).isEqualTo(UPDATED_REFERENCE);
//         assertThat(testReportType.getCategory()).isEqualTo(UPDATED_CATEGORY);
